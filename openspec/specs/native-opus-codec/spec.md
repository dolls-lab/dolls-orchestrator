# native-opus-codec Specification

## Purpose
Define the native raw-Opus codec boundary used to exchange validated 16 kHz uplink and 24 kHz downlink audio with terminal clients while keeping offline orchestration possible.
## Requirements
