# terminal-service-runner Specification

## Purpose
Define secure, readiness-gated assembly and lifecycle behavior for the runnable terminal WebSocket, raw-Opus, and orchestration service.
