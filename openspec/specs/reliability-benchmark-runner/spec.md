# reliability-benchmark-runner Specification

## Purpose
Define repeatable sequential voice-turn reliability, latency aggregation, recovery accounting, and privacy-preserving benchmark reports.
