# Character Evaluation Runner

## Purpose

Define independent fixture validation, isolated text-only execution, failure handling, and versioned unscored reporting for character evaluations.
